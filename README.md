...
You can enter your Location (or any other city in the world) in the search input, and hit enter or click the :mag: icon.
...
4. Go to my [API Keys](https://home.openweathermap.org/api_keys) and make sure your API Key is active.
5. Copy and paste the API Key and Url inside your JavaScript(.js) file. Make sure you include them for the features of the weather, and the forecast prediction.
