...
The HTML & CSS are from AsmrProg, JavaScript code is mine (I am not good at designing :cry:).
...
5. Copy and paste the API Key and Url inside your JavaScript(.js) file. Make sure you include them for features (weather, and the forecast prediction).
